...
/// 提供Storage iterator, 这样trait的实现者只需要
/// 把他们的iterator提供给StorageIter然后保证next传出的类型实现了Into<Kvpair>
...
impl <T: Iterator> Iterator for StorageIter<T> 
where T::Item : Into<Kvpair> {
    type Item = Kvpair;
